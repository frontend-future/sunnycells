...
(() => {
  ...
  const PACKAGES = {
    starter: { id:"starter", name:"Metabolic Morning Blend - 1 Jar", jars:1, unitPrice:89.99, total:89.99, image:"assets/images/metabolic-morning-blend.webp" },
    popular: { id:"popular", name:"Metabolic Morning Blend - 2 Jars", jars:2, unitPrice:84.99, total:169.99, image:"assets/images/pouch-3.webp" },
    savings: { id:"savings", name:"Metabolic Morning Blend - 4 Jars", jars:4, unitPrice:77.49, total:309.99, image:"assets/images/pouch-6.webp" }
  };
