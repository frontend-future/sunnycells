...
/** Centred modal on desktop, bottom sheet on mobile. The scrim is flat, never
    blurred: blur is reserved for the sticky header. */
export function Dialog({
  open = true, title, children, footer, onClose, variant = "modal", width = 520, style, ...rest
}: DialogProps) {
  if (!open) return null;
