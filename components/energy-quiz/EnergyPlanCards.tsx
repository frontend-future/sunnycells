...
/** The diet funnel's PlanCards, selling the other product. Same card, same grid, and
    the same job: store the choice, report it, and move to checkout. */
export function EnergyPlanCards({ destinationHref, ctaLabel = "Try now" }: { destinationHref: string; ctaLabel?: string }) {
