...
export const metadata: Metadata = {
  title: "Cortisol skin quiz | SUNNYCELLS",
  description:
    "Twenty-two questions, about two minutes. Find out whether nighttime cortisol is behind the puffiness, the fine lines and the loss of firmness.",
};
...
export default function CortisolQuizLandingPage() {
  return (
    <>
      <AnnouncementMarquee
        terms={[
      ...
      <div style={{ position: "relative", background: "var(--white)" }}>
        ...
        >
          ...
          <Image
            ...
            alt="A frosted glass SUNNYCELLS Youth Matrix jar filled with ruby tart-cherry chews, with loose chews beside it"
            width={1200}
            height={1200}
            priority
            style={{
      ...
      <main style={{ width: "100%", maxWidth: 720, margin: "0 auto", padding: "0 var(--page-gutter-mobile)" }}>
        <div style={{ textAlign: "center", paddingTop: "var(--space-6)" }}>
          ...
          >
            <span style={{ fontWeight: 600 }}>Reverse &ldquo;cortisol face&rdquo; &amp; restore youthful skin with </span>
            <span style={{ fontWeight: 900 }}>Youth Matrix Chews</span>
          </h1>
          ...
          >
            Balancing your levels of cortisol overnight can help with facial puffiness,
            fine lines, skin firmness and more.
          </p>

          <div style={{ display: "flex", justifyContent: "center", marginTop: "var(--space-4)" }}>
            <RatingPill value={4.9} count={1248} />
          </div>
