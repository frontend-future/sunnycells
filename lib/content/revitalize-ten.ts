...
export const REASONS: Reason[] = [
  { n: 1, title: "It shrinks stubborn \u201cCortisol Belly\u201d",
    body: "Stress forces your body to hoard weight around your midsection. Revitalize mutes that stress signal at the cellular level, telling your body it\u2019s safe to let go of lower-belly fat.",
  ...
  { n: 2, title: "It flushes away \u201cCortisol Face\u201d",
    body: "Unmanaged stress traps fluid in your face, leaving you puffy. Magnesium Glycinate restores fluid balance and flushes morning retention so you wake up with a sharp jawline.",
  ...
  { n: 3, title: "It stops early wrinkles before they start",
    body: "Cortisol breaks down your collagen. We pair Bovine Gelatin with Acerola Vitamin C to rebuild your skin matrix and shield your face from stress lines.",
  ...
  { n: 4, title: "It shields your eyes from screen damage",
    body: "Staring at laptops all day strains ocular tissue. Lutein, Zeaxanthin, and Vitamin C filter blue light to keep your eyes clear and fresh after 10-hour workdays.",
  ...
  { n: 5, title: "It kills relentless 3:30 PM cravings",
    body: "Afternoon pantry raids aren\u2019t a lack of willpower. 10 g of satiety-boosting gelatin aminos and konjac fiber keep you full and mute the urge to snack before dinner.",
  ...
  { n: 6, title: "It erases tired, baggy eyes",
    body: "Spiked evening stress ruins sleep and restricts facial blood flow. Revitalize lowers nighttime tension so you fall into deep sleep and wake up without dark circles.",
    photo: "/photos/revitalize/effects/eyes.webp", fit: "contain",
    alt: "A grid of faces showing under-eye bags and dark circles" },
  { n: 7, title: "It protects your hair from stress graying",
    body: "Chronic stress depletes the stem cells that produce natural hair pigment. Niacinamide shields your follicles from oxidative stress to keep your hair thick and vibrant.",
  ...
  { n: 8, title: "It\u2019s built with 100% clean ingredients",
    body: "No cheap fillers, synthetic dyes, or numbing herbs like Ashwagandha. Just pure, bioavailable nutrients like Bovine Gelatin and Magnesium Glycinate to fuel your cells naturally.",
  ...
  { n: 9, title: "It\u2019s third-party tested & backed by biochemistry",
    body: "No hidden proprietary blends or fake micro-doses. Every batch undergoes strict independent testing for purity, potency, and heavy metals before it ever reaches your desk.",
  ...
  { n: 10, title: "It works or you don\u2019t pay",
    body: "60 days to try it. If you don\u2019t see a visible difference in your face, waistline, and energy, you get a full refund. We take the risk, not you.",
