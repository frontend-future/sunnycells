...
export const metadata: Metadata = {
  title: "Sleep quiz | SUNNYCELLS",
  description:
    "Twenty-one questions, about two minutes. Get a read on your evening cortisol and what it is doing to your sleep.",
};
    ...
    <>
      ...
      <div style={{ position: "relative", background: "var(--white)" }}>
        ...
        >
          <Wordmark size={26} />
          <Image
            src="/product/anytime-calm.webp"
            alt="SC-26 Anytime Calm, a cream and cherry red tub of cherry lime powder"
            width={1024}
            height={1024}
            priority
            style={{
      ...
      <main style={{ width: "100%", maxWidth: 720, margin: "0 auto", padding: "0 var(--page-gutter-mobile)" }}>
        <div style={{ textAlign: "center", paddingTop: "var(--space-6)" }}>
          ...
          >
            <span style={{ fontWeight: 600 }}>Release stress &amp; sleep through the night with </span>
            <span style={{ fontWeight: 900 }}>Anytime Calm</span>
          </h1>
          ...
          >
            Balancing your cortisol levels can help you fall asleep faster, stay asleep
            longer, and wake up actually feeling rested.
          </p>
