...
<div style="background:${DEEP};color:#fff;padding:36px 70px 76px;text-align:center;position:relative">
  <img src="${img(S.guarantee.badge)}" style="position:absolute;left:50%;top:-150px;transform:translateX(-50%);width:270px;height:270px;object-fit:contain">
  <h1 class="d" style="font-size:72px;text-transform:uppercase;margin-top:132px">${S.guarantee.title}</h1>
