...
import { RATING } from "@/lib/products/dog-joint";

export const metadata: Metadata = {
  title: "Dog joint quiz | SUNNYCELLS",
  description: "A couple minutes of questions to find out why your dog is slowing down, and what to do about it.",
};
...
export default function JointQuizLandingPage() {
  return (
    <>
      <AnnouncementMarquee
        terms={[
      ...
      <div style={{ position: "relative", background: "var(--white)" }}>
        ...
        >
          ...
          {/* Before/after rather than a plain product shot: the transformation
              ...
              slowing down" hook before she's answered a single question. */}
          <div
            style={{
              display: "grid",
          ...
          >
            {[
              { src: "/quiz/joint/hero-before.webp", alt: "A dog struggling to get up, stiff and slow", label: "Before" },
              { src: "/quiz/joint/hero-after.webp", alt: "A happy, active dog jumping beside a jar of SC-02 Hip & Joint Chews", label: "After" },
            ].map((s) => (
      ...
      <main style={{ width: "100%", maxWidth: 720, margin: "0 auto", padding: "0 var(--page-gutter-mobile)" }}>
        <div style={{ textAlign: "center", paddingTop: "var(--space-6)" }}>
          ...
          >
            <span style={{ fontWeight: 900 }}>Discover why your dog is slowing down</span>
          </h1>
          ...
          >
            A couple minutes of questions to get to the root cause of the stiffness,
            limping, and joint discomfort, and what to do about it.
          </p>
