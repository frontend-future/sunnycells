...
import { FACTS, PRODUCT } from "@/lib/products/daily-reds";
import styles from "./nutrition-label.module.css";

/**
 * The supplement facts panel, behind the "View nutrition label" link.
 *
 * Every figure it renders comes from FACTS in the product file, which is invented and
 * flagged there. A facts panel is read literally by the FDA, so none of it ships without
 * coming off the real certificate of analysis.
 */
          ...
          <div className={styles.panel}>
            ...
            <div className={styles.facts}>
              ...
              <p className={styles.blend}>
                <strong>{FACTS.blendTitle}:</strong> {FACTS.blend}
              </p>
              <p className={styles.blend}>
            ...
            <p className={styles.legal}>{FACTS.storage}</p>
