...
import { RATING } from "@/lib/products/even-energy";
import { energyQuiz } from "@/lib/quiz/energy";

export const metadata: Metadata = {
  title: "Energy quiz | SUNNYCELLS",
  description:
    "Twenty questions, about two minutes. Find out why your energy gives out and what caffeine has to do with it.",
};
...
export default function EnergyQuizLandingPage() {
  return (
    <>
      <AnnouncementMarquee
        terms={[
      ...
      <div style={{ position: "relative", background: "var(--white)" }}>
        ...
        >
          ...
          <Image
            ...
            alt="SC-22 Even Energy, a light green pouch of watermelon stick packs"
            width={1024}
            height={768}
            priority
            style={{
      ...
      <main style={{ width: "100%", maxWidth: 720, margin: "0 auto", padding: "0 var(--page-gutter-mobile)" }}>
        <div style={{ textAlign: "center", paddingTop: "var(--space-6)" }}>
          ...
          >
            <span style={{ fontWeight: 600 }}>Get steady energy without caffeine with </span>
            <span style={{ fontWeight: 900 }}>Even Energy</span>
          </h1>
          ...
          >
            Find out why your energy gives out in the afternoon, and what the coffee at
            seven has to do with it.
          </p>
