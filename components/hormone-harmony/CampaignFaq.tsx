...
const faqItems = [
  ...
  { title: "Does it contain sugar?", body: "No. The product label states zero sugar." },
  { title: "How many calories does it contain?", body: "The product label states zero calories per serving." },
  ...
  { title: "Can I skip a delivery?", body: "Yes. You can skip a delivery according to the subscription terms." },
  { title: "Can I cancel my subscription?", body: "Yes. You can cancel the subscription anytime according to the subscription terms." },
  ...
  { title: "Can I use it with prescription medication?", body: "Speak with your healthcare professional before use if you take prescription medication. They can review the formula against your individual needs." },
